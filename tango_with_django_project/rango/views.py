...
def register(request):
    ...
    # Set to False initialy. code changes value to
...
def user_login(request):
    ...
    if request.method == 'POST':
        ...
        # We use the request.POST.get('<variable>') as poosed to
        # reqeust.POST.get['<variable>'] returns None if the 
        ...
        # with matching credentails was found.
        if user:
    ...
    # The request is not a HTTP POST, so displayl the login form.
